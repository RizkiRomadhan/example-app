                        ...
                        <div class="col-12 mt-4">
                            <div class="row justify-content-between">
                                <div class="col-7 col-lg-9">
                                    <a class="btn btn-primary" href="{{ route('list-bimbingan.create') }}" role="button">
                                        Tambah</a>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse ($bimbingan as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('list-bimbingan.destroy', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')

                                                        <a href="{{ route('list-bimbingan.edit', $data->id) }}"
